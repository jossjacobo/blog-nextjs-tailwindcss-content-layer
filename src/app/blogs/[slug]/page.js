      ...
      <article key={params.slug}>
        ...
        <div className="grid grid-cols-12 gap-16 mt-8 px-10">
          <div className="col-span-4">
            <details
              className="border-[1px] border-solid border-dark text-dark rounded-lg
            p-4 sticky top-6 max-h-[80vh] overflow-hidden overflow-y-auto"
              open
            >
                ...
                {blog.toc.map((heading) => {
                  return (
                    <li key={`#${heading.slug}`} className="py-1">
                      ...
                      >
                        {heading.level === "three" && (
                          <span className="flex w-1 h-1 rounded-full mr-2 bg-dark">
                            &nbsp;
                          </span>
                        )}
